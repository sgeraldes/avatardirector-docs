...
4. **¿El build stamp es actual?** La fila header del overlay de depuración muestra el build stamp (ej. `Apr 22 2026 01:13`). Si estás en una build vieja, el bug puede estar arreglado ya — chequeá las [notas de versión](/es/releases/ls009).
...
Catálogo completo: [Ajustes de lip-sync § Log de auditoría de compliance](/es/protocol/lipsync-settings#6-log-de-auditoría-de-compliance).
